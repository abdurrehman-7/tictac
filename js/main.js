        ...
        products = [
            {
                ...
                price: 8999,
                image: "images/products/backpack-leather.jpg",
                fallbackImage: "https://via.placeholder.com/300x300/007bff/ffffff?text=Leather+Backpack",
            ...
            },
            {
                ...
                price: 12499,
                image: "images/products/handbag-designer.jpg",
                fallbackImage: "https://via.placeholder.com/300x300/28a745/ffffff?text=Designer+Handbag",
            ...
            },
            {
                ...
                fallbackImage: "https://via.placeholder.com/300x300/ffc107/ffffff?text=Travel+Duffel",
            ...
            },
            {
                ...
                fallbackImage: "https://via.placeholder.com/300x300/dc3545/ffffff?text=Laptop+Bag",
            ...
            },
            {
                ...
                fallbackImage: "https://via.placeholder.com/300x300/6c757d/ffffff?text=Canvas+Tote",
            ...
            },
            {
                ...
                fallbackImage: "https://via.placeholder.com/300x300/17a2b8/ffffff?text=Gym+Bag",
...
function loadBrands() {
    ...
    if (storedBrands) {
        ...
        brands = [
            { id: 1, name: "TicTac Premium", logo: "images/brands/tictac-premium.jpg", fallbackLogo: "https://via.placeholder.com/150x80/333/ffffff?text=TicTac+Premium", active: true },
            { id: 2, name: "Fashion Forward", logo: "images/brands/fashion-forward.jpg", fallbackLogo: "https://via.placeholder.com/150x80/333/ffffff?text=Fashion+Forward", active: true },
            { id: 3, name: "Adventure Pro", logo: "images/brands/adventure-pro.jpg", fallbackLogo: "https://via.placeholder.com/150x80/333/ffffff?text=Adventure+Pro", active: true },
            { id: 4, name: "TechCarry", logo: "images/brands/techcarry.jpg", fallbackLogo: "https://via.placeholder.com/150x80/333/ffffff?text=TechCarry", active: true },
            { id: 5, name: "Casual Co.", logo: "images/brands/casual-co.jpg", fallbackLogo: "https://via.placeholder.com/150x80/333/ffffff?text=Casual+Co", active: true },
            { id: 6, name: "FitActive", logo: "images/brands/fitactive.jpg", fallbackLogo: "https://via.placeholder.com/150x80/333/ffffff?text=FitActive", active: true }
        ];
...
function loadFeaturedBrands() {
    ...
    for (let i = 0; i < activeBrands.length; i += 4) {
        ...
        brandGroup.forEach(brand => {
            ...
            col.innerHTML = `<img src="${brand.logo}" class="img-fluid brand-logo" alt="${brand.name}" onerror="this.src='${brand.fallbackLogo}'">`;
            row.appendChild(col);
        });
...
function createProductCard(product) {
    ...
    col.innerHTML = `
        <div class="card product-card h-100">
            <img src="${product.image}" class="card-img-top" alt="${product.title}" onerror="this.src='${product.fallbackImage}'">
